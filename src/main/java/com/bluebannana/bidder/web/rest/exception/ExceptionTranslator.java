package com.bluebannana.bidder.web.rest.exception;

import com.bluebannana.bidder.config.Constants;
import com.bluebannana.bidder.exception.BidderException;
import com.bluebannana.bidder.web.rest.view.ErrorView;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorView> handleBidderException(BidderException ex) {
        log.error(ex.getMessage());
